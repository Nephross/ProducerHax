...
router.post('/podcast', multer.upload.single('profile_picture'), (req, res, next) => {
...
router.put('/podcast/:podcastId', auth.authenticateJWT, multer.upload.single('profile_picture'), (req, res, next) => {
